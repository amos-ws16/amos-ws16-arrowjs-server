...
/**
 * Uses the string-similiarity module to compare the file title and the task description
 *
...
/**
 * Uses the string-similiarity module to compare the file description and the task description
 *
 * @param file - the file with its title
 * @param task - the task with its description
 */
