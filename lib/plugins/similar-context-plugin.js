 ...
 * @param keywordParam - object with attribute extractKeywords as parameter for extracting the keywords (true - extract keyword before calculating similarity score, false - whithout extraction)
 */
function similarityPlugin (sString1, sString2, params) {
  ...
  if ((extractKeywords === false)) {
    ...
    throw new Error(`extractKeywords param must be a boolean`)
  }
}
